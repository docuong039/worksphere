...
export default async function DashboardPage({ searchParams }: { searchParams: Promise<{ [key: string]: string | string[] | undefined }> }) {
    ...
    // Fetch toàn bộ logic từ Service
    const data = await DashboardServerService.getDashboardData(session.user, selectedProjectId);
        ...
        <div className="space-y-8 pb-10">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-4">
                    <DashboardFilter projects={isManagerView ? managedProjects as any : projects as any} />
                </div>
            </div>
                ...
                <div className="lg:col-span-2 space-y-6">
                    ...
                    <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
                        ...
                        <div className="divide-y divide-gray-50">
                            {displayProjects.slice(0, 6).map((proj: any) => {
                                const p = proj;
